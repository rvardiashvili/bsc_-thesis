...
```bash
pip install torch lightning configilm huggingface_hub rasterio numpy tqdm
```
...
The main entry point for the pipeline is `src/ben_v2/main.py`. You can run it from the command line, providing the path to the Sentinel-2 tile folder and an output directory.

```bash
python src/ben_v2/main.py --tile_folder /path/to/your/S2A_MSIL1C_..._tile_folder --output_folder /path/to/your/output_folder
```
